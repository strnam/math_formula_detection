...
class Model:
      ...
      def retrieveModel(self):
          with open(self.file, 'r') as input:
              list_maps = json.load(input)
              self.tmap = list_maps[0]
              self.emap = list_maps[1]
              self.singtt = list_maps[2]
              self.singtw = list_maps[3]
              self.ct = list_maps[4]
              self.cw = list_maps[5]
              self.tagDict = list_maps[6]
